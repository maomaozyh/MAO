...
import com.mao.maocodemother.model.dto.chathistory.ChatHistoryQueryRequest;
import com.mao.maocodemother.model.entity.App;
import com.mao.maocodemother.model.entity.ChatHistory;
import com.mao.maocodemother.mapper.ChatHistoryMapper;
...
public class ChatHistoryServiceImpl extends ServiceImpl<ChatHistoryMapper, ChatHistory> implements ChatHistoryService {
    ...
    public List<ChatHistory> listRecentMessages(Long appId, Long userId, int limit) {
        ThrowUtils.throwIf(appId == null || appId <= 0, ErrorCode.PARAMS_ERROR, "应用ID不能为空");
        ThrowUtils.throwIf(userId == null || userId <= 0, ErrorCode.PARAMS_ERROR, "用户ID不能为空");
        ThrowUtils.throwIf(limit <= 0 || limit > 50, ErrorCode.PARAMS_ERROR, "查询条数必须在1-50之间");
        QueryWrapper queryWrapper = QueryWrapper.create()
