...
public class ProductCatalog {
    ...
    public ProductCatalog() {
        ...
        // 增购积分
        put("SECONDS", "SEC_1000", "1000 积分", "22");
        put("SECONDS", "SEC_2000", "2000 积分", "44");
        put("SECONDS", "SEC_4000", "4000 积分", "88");
        put("SECONDS", "SEC_8000", "8000 积分", "176");
        put("SECONDS", "SEC_16000", "16000 积分", "320");
        put("SECONDS", "SEC_28000", "28000 积分", "560");
        put("SECONDS", "SEC_48000", "48000 积分", "960");
        put("SECONDS", "SEC_72000", "72000 积分", "1440");
        put("SECONDS", "SEC_100000", "100000 积分", "2000");
        put("SECONDS", "SEC_124500", "124500 积分", "2490");
        put("SECONDS", "SEC_190000", "190000 积分", "3800");
        put("SECONDS", "SEC_260000", "260000 积分", "5200");
        ...
        // 选购卡券 - 积分卡券
        put("CARD", "POINT_1000", "1000 积分卡券", "22");
        put("CARD", "POINT_2000", "2000 积分卡券", "44");
        put("CARD", "POINT_4000", "4000 积分卡券", "88");
        put("CARD", "POINT_8000", "8000 积分卡券", "176");
        put("CARD", "POINT_16000", "16000 积分卡券", "320");
        put("CARD", "POINT_28000", "28000 积分卡券", "560");
        put("CARD", "POINT_48000", "48000 积分卡券", "960");
        put("CARD", "POINT_72000", "72000 积分卡券", "1440");
    }
