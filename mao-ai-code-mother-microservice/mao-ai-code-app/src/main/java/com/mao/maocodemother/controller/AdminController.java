...
public class AdminController {
    ...
    public BaseResponse<DashboardStatsVO> getDashboardStats() {
        ...
        // 总数统计（用户走 Dubbo 远程调 user 模块，其余走本地服务）
        stats.setTotalUsers(innerUserService.countUsers());
        ...
        stats.setTodayNewUsers(innerUserService.countUsersSince(todayStart));
        ...
        stats.setWeekNewUsers(innerUserService.countUsersSince(weekStart));
        ...
        for (int i = 6; i >= 0; i--) {
            ...
            long userCount = innerUserService.countUsersBetween(dayStart, dayEnd);
