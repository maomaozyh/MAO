...
public class CommunityPostController {
     ...
     */
    @PostMapping("/add")
    public BaseResponse<Long> addPost(@RequestBody CommunityPostAddRequest postAddRequest, HttpServletRequest request) {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> adminDeletePost(@RequestBody DeleteRequest deleteRequest) {
