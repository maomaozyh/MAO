package com.mao.maocodeuser.controller;
...
public class UserController {
    ...
    public BaseResponse<com.mao.maocodemother.model.vo.MembershipVO> getMembership(HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        return ResultUtils.success(userService.getMembershipVO(loginUser));
    }
